...
class Calendar
{
    ...
    */
    ...
    /*
        Return the XML for the current month
    */

    function getCurrentMonthViewXML()
    {
        $d = getdate(time());
        return $this->getMonthViewXML($d["mon"], $d["year"]);
    }
	function getMonthViewXML($month, $year)
    {
        return $this->getMonthXML($month, $year);
    }
    ...
    */
    function getMonthXML($m, $y, $showYear = 1)
    {
        $s = "";
    ...
    function getMonthHTML($m, $y, $showYear = 1)
    {
    	...
    	$s .= "<table class=\"calendarBody\" cellspacing=\"0\" cellpadding=\"0\">\n";
    	//$s .= "<tr>\n";
    	...
    	while ($d <= $daysInMonth)
    	{
    	    ...
    	    for ($i = 0; $i < 7; $i++)
    	    {
    	        ...
    	        {
    	            $link = $this->getDateLink($d, $month, $year);
    	            $s .= (($link == "") ? $d : "<a class=\"calendarLink\" href=\"$link\">$d</a>");
    	        }
    	        else
    	        {
    	            $s .= "&nbsp;";
    ...
    */
    function getYearHTML($year)
    {
        ...
        $s .= "<table class=\"calendarBody\" border=\"0\">\n";
        $s .= "<tr>";
