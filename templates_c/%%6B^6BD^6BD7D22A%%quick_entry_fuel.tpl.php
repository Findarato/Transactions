<?php /* Smarty version 2.6.18, created on 2010-06-11 15:53:32
         compiled from quick_entry_fuel.tpl */ ?>
<div id="newFuelEntrydialog">
	<div class="border-all-B-1 color-D-1" style="padding:5px;">
				<form id="transactionsFuel" name="fuel" method="post">
					<table width="100%" cellpadding="0" cellspacing="0">
						...
						<tr>
							<td>Car</td>
							<td><input type="text" name="car" style="width:7em; " maxlength="5"></td>
						</tr>
					</table>
			...
			<div class="table textLeft" style="width:100px">
				...
				<div class="td"><a class="option-theme fg-button ui-corner-all white lapcatButton" id="addFuelBtn">Add</a></div>
			</div>
		</div>		
	</div>
</div>